...
public class EmailService {
    ...
    public void sendHtmlEmail(String to, String subject, String htmlContent, String ticketId, String eventName) {
        ...
        // Write HTML to local directory for visual inspection and local development
        // support
        try {
    ...
    public void sendTicketStatusChangedEmail(User creator, Ticket ticket, Status oldStatus) {
        ...
        String lead = "The status of your support ticket has been updated from **" + oldStatus.name() + "** to **"
        ...
        sendHtmlEmail(creator.getEmail(), subject, htmlBody, String.valueOf(ticket.getId()),
                "status_" + ticket.getStatus().name().toLowerCase());
    }
    ...
    public void sendNewCommentEmail(User recipient, User commenter, Ticket ticket, String commentText) {
        ...
        String lead = "A new message was added to the discussion thread on your ticket by **" + commenter.getUsername()
    ...
    private String buildHtmlTemplate(
        ...
        if (priority == Priority.MEDIUM)
            priorityBg = "#f59e0b"; // Amber
        else if (priority == Priority.HIGH)
            priorityBg = "#f97316"; // Orange
        else if (priority == Priority.URGENT)
            priorityBg = "#ef4444"; // Red
        ...
        if (additionalTitle != null && additionalBody != null && !additionalBody.isBlank()) {
            additionalSection = "<tr>" +
                    "  <td style='padding: 24px 0 12px 0;'>" +
                    "    <h4 style=\"font-family: 'Outfit', sans-serif; font-size: 15px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.05em; color: #9ca3af; margin: 0 0 10px 0;\">"
                    + additionalTitle + "</h4>" +
                    "    <div style=\"background-color: rgba(255, 255, 255, 0.02); border-left: 3px solid "
                    + accentColorHex
                    + "; padding: 16px 20px; border-radius: 0 8px 8px 0; font-family: 'Inter', sans-serif; font-size: 14px; line-height: 22px; color: #d1d5db; font-style: italic;\">"
                    +
        ...
        return "<!DOCTYPE html>" +
                ...
                "          <!-- Accent Bar -->" +
                "          <tr>" +
                "            <td height='6' style='background-color: " + accentColorHex
                + "; line-height: 6px; font-size: 1px;'>&nbsp;</td>" +
                "          </tr>" +
                "          " +
                "          <!-- Content -->" +
                "          <tr>" +
                ...
                "              <p style=\"font-size: 16px; line-height: 24px; color: #ffffff; margin: 0 0 12px 0; font-weight: 600;\">Hello "
                + greeting + ",</p>" +
                "              <p style=\"font-size: 15px; line-height: 24px; color: #9ca3af; margin: 0 0 28px 0; font-weight: 400;\">"
                + leadMessage + "</p>" +
                "              " +
                "              <!-- Ticket Info Box -->" +
                ...
                +
                "                    <span style=\"font-family: 'Outfit', sans-serif; font-size: 17px; font-weight: 700; color: #ffffff;\">Ticket #"
                + ticketId + "</span>" +
                "                  </td>" +
                "                </tr>" +
                "                <tr>" +
                ...
                +
                "                        <td width='70%' style=\"font-size: 14px; font-weight: 600; color: #ffffff; padding-bottom: 10px;\">"
                + subject + "</td>" +
                "                      </tr>" +
                "                      <!-- Status -->" +
                "                      <tr>" +
                ...
                "                          <span style=\"display: inline-block; background-color: " + statusBg
                + "; color: #ffffff; font-size: 10px; font-weight: 700; text-transform: uppercase; padding: 3px 8px; border-radius: 9999px; letter-spacing: 0.05em;\">"
                + status.name() + "</span>" +
                "                        </td>" +
                "                      </tr>" +
                "                      <!-- Priority -->" +
                ...
                +
                "                        <td style='padding-bottom: 10px;'>" +
                "                          <span style=\"display: inline-block; background-color: " + priorityBg
                + "; color: #ffffff; font-size: 10px; font-weight: 700; text-transform: uppercase; padding: 3px 8px; border-radius: 9999px; letter-spacing: 0.05em;\">"
                + priority.name() + "</span>" +
                "                        </td>" +
                "                      </tr>" +
                ...
                +
                "                        <td style=\"font-size: 14px; color: #d1d5db; font-weight: 500;\">"
                + assigneeName + "</td>" +
                "                      </tr>" +
                "                    </table>" +
                "                  </td>" +
                ...
                "                    <a href='" + ticketUrl
                + "' style=\"display: inline-block; background: linear-gradient(135deg, #3b82f6 0%, #06b6d4 100%); color: #ffffff; font-family: 'Outfit', sans-serif; font-weight: 600; font-size: 14px; padding: 12px 28px; border-radius: 8px; box-shadow: 0 4px 14px rgba(59, 130, 246, 0.3);\">View Ticket on Dashboard</a>"
                +
                "                  </td>" +
                "                </tr>" +
                "              </table>" +
